...
//	    private static final int BUTTON_SHUFFLE=2;
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        final RemoteViews views = new RemoteViews(context.getPackageName(),
                (WIDGET_STYLE.equals(context.getResources().getString(R.string
                        .widget_style_light)) ?
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(Constant.CTL_ACTION)) {
            ...
            PendingIntent intent_prev = PendingIntent.getBroadcast(context, 1, buttonIntent,
            ...
            PendingIntent intent_next = PendingIntent.getBroadcast(context, 3, buttonIntent,
                    PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            PendingIntent intent_repeat = PendingIntent.getBroadcast(context, 4, buttonIntent,
                    PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            PendingIntent intent_shuffle = PendingIntent.getBroadcast(context, 5, buttonIntent,
                    PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            switch (intent.getIntExtra("MSG", 0)) {
                case Constant.playMSG.SHUFFLE_MSG:
                    switch (intent.getIntExtra("repeat", 0)) {
                        case Constant.repeatState.isShuffle:
                            ...
                            views.setImageViewResource(R.id.four_by_two_control_shuffle, R.mipmap
                                    .apollo_holo_light_shuffle_on);
                            break;
                        case Constant.repeatState.isOrder:
                            Toast.makeText(context, "随机播放已关闭", Toast.LENGTH_SHORT).show();
                            views.setImageViewResource(R.id.four_by_two_control_shuffle, R.mipmap
                                    .apollo_holo_light_shuffle_normal);
                            break;
                    }
                    views.setImageViewResource(R.id.four_by_two_control_repeat, R.mipmap
                            .apollo_holo_light_repeat_normal);
                    break;
                ...
                case Constant.playMSG.PLAY_MSG:
                    views.setImageViewResource(R.id.four_by_two_control_play, R.mipmap
                            .apollo_holo_light_pause);
                    break;
                case Constant.playMSG.PAUSE_MSG:
                    views.setImageViewResource(R.id.four_by_two_control_play, R.mipmap
                            .apollo_holo_light_play);
                    break;
                ...
                case Constant.playMSG.LOCATION_MSG:
                    ...
                    Bitmap bm = Constant.getArtwork(context, intent.getLongExtra("Id", 0), intent
                            .getLongExtra("AlbumId", 0), true, false);
