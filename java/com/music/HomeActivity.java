...
public class HomeActivity extends Activity {
    ...
    public TextView progressView; // 歌曲进度
...
//			if(msg.getData().getInt("duration", 0) > 0){
            if (msg.what == 1) {
                progressView.setText(Constant.formatTime(msg.getData().getInt("currentTime")));
            }
        }
    };
    @Override
    ...
    public class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Constant.LRC_ACTION)) {
                ...
                bundleData.putInt("currentTime", intent.getIntExtra("currentTime", 0));
                ...
                switch (intent.getIntExtra("MSG", 0)) {
                    ...
                    case Constant.playMSG.LOCATION_MSG:
                        progressView.setText(Constant.formatTime(intent.getExtras().getInt
                                ("currentTime")));
                        titleView.setText(intent.getExtras().getString("title"));
                        artistView.setText(intent.getExtras().getString("artist"));
                        durationView.setText(Constant.formatTime(intent.getExtras().getInt
                                ("duration")));
