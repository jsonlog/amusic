...
//	    sendIntent(Constant.playMSG.PLAY_MSG);
        ...
        Log.v("PLAYING", "oncreate" + titleView.getText());
    }
...
//	}
    public void showNotify(int MSG, String title, String artist, long Id, long AlbumId) {
        ...
        if (MSG == Constant.playMSG.PAUSE_MSG) {
            views.setImageViewResource(R.id.btn_custom_play, R.mipmap.btn_play);
            return;
        } else if (MSG == Constant.playMSG.PLAY_MSG) {
            views.setImageViewResource(R.id.btn_custom_play, R.mipmap.btn_pause);
            return;
        } else {
            views.setImageViewResource(R.id.btn_custom_play, R.mipmap.btn_pause);
        }
        if (Id == 0) {
            views.setImageViewResource(R.id.custom_song_icon, R.mipmap.icon);
        } else {
...
//		notify.contentIntent = PendingIntent.getActivity(this, 0, new Intent(), 0);
    ...
    public void voicePanelAnimation() {
        if (ll_player_voice.getVisibility() == View.GONE) {
            ll_player_voice.startAnimation(AnimationUtils.loadAnimation(PlayActivity.this, R.anim
                    .push_up_in));
        ...
        public void onProgressChanged(SeekBar seekBar, int progress,
            ...
            switch (seekBar.getId()) {
                ...
                case R.id.sb_player_voice:
                    ...
                    ll_player_voice.startAnimation(AnimationUtils.loadAnimation(PlayActivity
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.previous_music:
                    MSG = Constant.playMSG.PREVIOUS_MSG;
                    break;
                case R.id.next_music:
                    MSG = Constant.playMSG.NEXT_MSG;
                    break;
                case R.id.shuffle_music:
                    MSG = Constant.playMSG.SHUFFLE_MSG;
                    break;
                case R.id.repeat_music:
                    MSG = Constant.playMSG.REPEAT_MSG;
                    break;
                case R.id.play_music:
                    MSG = Constant.playMSG.PLAY_MSG;
                    break;
    ...
    private void showPlayQueue() {
        ...
        View playQueueLayout = layoutInflater.inflate(R.layout.play_queue_layout, (ViewGroup)
                findViewById(R.id.play_queue_layout));
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, queues, R.layout.play_queue_item_layout,
                new String[]{"title",
                        "Artist", "duration"}, new int[]{R.id.music_title, R.id.music_Artist, R.id
                .music_duration});
            ...
            if (action.equals(Constant.LRC_ACTION)) {
                ...
                switch (intent.getIntExtra("MSG", 0)) {
                    ...
                    case Constant.playMSG.LOCATION_MSG:
                        ...
                        music_progressBar.setMax(duration);
                        showNotify(intent.getIntExtra("MSG", 0), title, artist, intent
                                .getLongExtra("Id", 0), intent.getLongExtra("AlbumId", 0));
                        collapseStatusBar(context);
                        playBtn.setBackgroundResource(R.drawable.pause_selector);
                        break;
                    case Constant.playMSG.PAUSE_MSG:
                        playBtn.setBackgroundResource(R.drawable.play_selector);
                        showNotify(intent.getIntExtra("MSG", 0), "", "", 0, 0);
                        collapseStatusBar(context);
                        break;
